...
$phiTdata=array("PiwsUtra-1.1:Pizo'nta udAttaH","PiwsUtra-1.2:pAwalApAlaNkAmbAsAgarArTAnAm","PiwsUtra-1.3:gehArTAnAmastriyAm","PiwsUtra-1.4:gudasya ca","PiwsUtra-1.5:DyapUrvasya strIvizayasya",);
...
function gui3($text,$sutra_number,$style,$note)
{
	...
	$i=0;
	if (strpos($sutra_number,'PiwsUtra-')!==false && $frontend==='1')
	{
		...
		if ($sutra_no[$i] === $sutra_number)
		{	
			echo "<p class = ".$style." >By ".toiast($sutra_slp[$i])." (".$sutra_number.") :</p>\n";
