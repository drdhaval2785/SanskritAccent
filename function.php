...
$nipAta=array("ca","vA","ha","eva","evam","evaM","nUnam","nUnaM","SaSvat","SaSvad","yugapat","yugapad","BUyas","BUyaH","kUpat","kUpad","sUpat","sUpad","kuvit","kuvid","net","ned","cet","ced","caR","kaccit","kaccid","kiYcit","kiYcid","yatra","naha","hanta","mAkiH","mAkis","mAkim","mAkiM","nakiH","nakis","Akim","AkiM","nakim","nakiM","mAN","naY","yAvat","yAvad","tAvat","tAvad","tvE","dvE","nvE","rE","SrOzaw","vOzaw","svAhA","svaDA","vazaw","om","oM","tum","tuM","taTAhi","Kalu","aTo","aTa","suzWu","sma","Adaha","avadattam","ahaMyus","ahaMyuH","astikzIrA","a","A","i","I","u","U","e","E","o","O","paSu","Sukam","yaTA","kaTA","taTA","pAw","pyAw","aNga","hE","he","Bos","BoH","aye","dya","vizu","ekapade","yut","yud","Atas","AtaH");
...
$phiTdata=array("Pi-1:Pizo'nta udAttaH","Pi-2:pAwalApAlaNkAmbAsAgarArTAnAm","Pi-3:gehArTAnAmastriyAm","Pi-4:gudasya ca","Pi-5:DyapUrvasya strIvizayasya","Pi-6:KAntasyASmAdeH","Pi-7:baMhizWavatsaratiSatTAntAnAm","Pi-8:dakziRasya sADO","Pi-9:svANgAKyAyAmAdirvA","Pi-10:Candasi ca","Pi-11:kfzRasyAmfgAKyA cet","Pi-12:vA nAmaDeyasya","Pi-13:SuklagOrayorAdiH","Pi-14:aNguzWodakabakavaSAnAM CandasyantaH","Pi-15:pfzWasya ca","Pi-16:arjunasya tfRAKyA cet","Pi-17:Aryasya svAmyAKyA cet","Pi-18:ASAyA adigAKyA cet","Pi-19:nakzatrARAmabvizayARAm","Pi-20:na kupUrvasya kfttikAKyA cet","Pi-21:GftAdInAM ca","Pi-22:jyezWakanizWayorvayasi","Pi-23:bilvatizyayoH svarito vA","Pi-24:aTAdiH prAk SakaweH","Pi-25:hrasvAntasya strIvizayasya","Pi-26:nabvizayasyAnisantasya","Pi-27:tfRaDAnyAnAM ca dvyazAm","Pi-28:nraH saNKyAyAH","Pi-29:svANgaSiwAmadantAnAm","Pi-30:prARinAM kupUrvam","Pi-31:KayyuvarRaM kftrimAKyA cet","Pi-32:unarvannantAnAm","Pi-33:varRAnAM taRatinitAntAnAm","Pi-34:hrasvAntasya hrasvamanftAcCIlye","Pi-35:akzasyAdevanasya","Pi-36:arDasyAsamadyotane","Pi-37:pItadrvarTAnAm","Pi-38:grAmAdInAM ca","Pi-39:lubantasyopameyanAmaDeyasya","Pi-40:na vfkzaparvataviSezavyAGrasiMhamahizARAm","Pi-41:rAjaviSezasya yamanvA cet","Pi-42:laGAvante dvayoSca bahvazo guruH","Pi-43:strIvizayavarRAkzupUrvARAm","Pi-44:SakunInAM ca laGu pUrvam","Pi-45:nartuprARyAKyAyA
$pattern2 = '/([aiufx])([^aAiIuUfFxXeEoO]{2})([aiufx])([^aAiIuUfFxXeEoO])([aiufx])$/';
$ajantajanapada = array("kamboja","ganDAra","kapiSa","bAlhIka","prakaRva","praskaRva","sinDu","sOvIra","brAhmaRaka","SOdrAyaRa","apakara","pAraskara","kacCa","kekaya","madra","uzInara","ambazWa","trigarta","kalakUwa","kuru","sAlva","pratyagraTa","ajAqa","raNku","BAradvAja","kosala","kAzi","vfji","magaDa","kaliNga","sUramasa","avanti","kunti","Azmaka","barbara","kaSmIra","urazA","gabdikA","pawaccara","sarvasena","sArvaseni","fzika","jihnu"); // See https://github.com/drdhaval2785/SanskritAccent/issues/80 for details.
...
/* displaying phiT from storedata */
function display_phiT()
{
	global $storedata;
	foreach ($storedata as $value)
	{
...
/* Function gui3 for phiTsUtras. */
function gui3($text,$sutra_number,$style,$note)
{
	global $phiTdata, $frontend; 
	$i=0;
	if (strpos($sutra_number,'Pi-')!==false && $frontend==='1')
	{
		$matches = array_filter($phiTdata, function($var) use ($sutra_number) { return strpos($var,$sutra_number.":")!==false; });
		$matches=array_values($matches);
		$int = explode(':',$matches[0]); // We presume that there would be only one such match.
		$sutra_no[$i] = $int[0];
		$sutra_slp[$i] = $int[1];
		if ($sutra_no[$i] === $sutra_number)
		{	
			echo "<p class = ".$style." >By ".toiast($sutra_slp[$i])." (".toiast($sutra_number).") :</p>\n";
			echo "<p class = ".$style." >".convert($sutra_slp[$i])." (".convert($sutra_number).") :</p>\n";
			display2($text,$note);
/*			fputs($outfile,"<p class = ".$style." >By ".toiast($sutra_slp[$i])." (".link_sutra($sutra_number).") :</p>\n");
			fputs($outfile,"<p class = ".$style." >".convert($sutra_dev[$i])." (".convert($sutra_number).") :</p>\n");
			fputs($outfile,"<hr/>");*/
		}		
	}
}
...
{
	$style="st";
	global $ASdata, $vdata, $miscdata, $frontend; global $upasarga_joined; global $us, $outfile, $otherdata; // bringing $text from main php function.
	$i=0;
	if (strpos($sutra_number,'~')!==false && $frontend==='1')
	{
		$matches = array_filter($otherdata, function($var) use ($sutra_number) { return strpos($var,$sutra_number.":")!==false; });
...
{
	global $text;
	$pattern1 = '/([AIUFeoEO])([^aAiIuUfFxXeEoO]*)([aiufx])$/';
	$pattern2 = '/([AIUFeoEO])/';
	if (twolaghuoneguru() && arr($text,'/[aiufx]$/'))
	{
		preg_accent($pattern2,'$1^',0);
	}
	elseif (arr($text,$pattern1))
	{
		preg_accent($pattern1,'$1^$2$3',0);
	}
	return $text;
}
function twolaghuoneguru()
{
	global $text;
	foreach ($text as $val)
	{
		$break = preg_split('/[AIUFXeoEO]/',$val);
		$break2 = preg_split('/[aiufx]/',$val);
		if (count($break)>1 && count($break2)>2)
		{ $con[]=1; break; }
	}
	if (in_array(1,$con))
	{
